...
void Relational(void)
{
 ...
 сообщения */
  ...
  if((friends + beatles >= baseball) && (friends + avengers >= football))
    {
      printf("\nАктеры \"Друзей\" и участники Beatles ");
 ...
 напечатаны сообщения */
  ...
  if((starWars <= months) || (potterBooks <= months))
    ...
    {
      printf("\nНичего из этого не может произойти: слишком много книг и фильмов,\n");
